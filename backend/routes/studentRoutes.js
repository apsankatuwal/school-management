...
router.post("/", auth, role("admin"), studentValidator, validate, createStudent);

router.get("/", auth, role("admin"), getAllStudents);

// Must be registered before "/:id"
router.get("/me", auth, role("student"), getMyProfile);

router.get("/:id", auth, role("admin"), getStudentById);
